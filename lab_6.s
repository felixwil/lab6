...
isgameover:	.byte 0x00
end_prompt:	.string "GAME OVER your final score is: ", 0
...
movement_counter:	.byte	0x00	; The .byte assembler directive stores a byte
switch_speed:	.byte	0x01	; This is where you can store data.
current_direction:	.byte	0x64			; The .byte assembler directive stores a byte
			; (initialized to 0x20) at the label mydata.
			; Halfwords & Words can be stored using the
			; directives .half & .word
uartresult:		.byte	0x00
xposition:		.byte	10 ; 1 <= x <= 20
yposition:		.byte	10 ; 0 <= y <= 19
...
ptr_to_isgameover:		.word isgameover
...
ptr_to_movement_counter:		.word movement_counter
...
game_over:
	...
	ldr r0, ptr_to_movement_counter
	ldrb r0, [r0]
